 ...
 */
  onLoad: function (options) {
    ...
    this.setData({
      ...
      mArray: [['今天', '明天', '后天', day4, day5, day6, day7], ['0点-1点', '1点-2点', '2点-3点', '3点-4点', '4点-5点', '5点-6点', '6点-7点', '7点-8点', '8点-9点', '9点-10点', '10点-11点', '11点-12点', '12点-13点', '13点-14点', '14点-15点', '15点-16点', '16点-17点', '17点-18点', '18点-19点', '19点-20点', '20点-21点', '21点-22点', '22点-23点', '23点-0点']],
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        // }
        if (that.data.userAddresses.length>0){
  ...
  formSubmit: function (e) {
    ...
    if (this.data.newIndex){
      ...
      else if (!that.data.itemNameSelect) {
        that.setData({
          btnDis: false
        })
        wx.showToast({
  ...
  // testUpdatePic:function(){
  //   console.log(this.data.imageList[0])
  //   var that = this;
  //   wx.uploadFile({
  //     url: app.globalData.url +'/api/file/ulpic/9', //orderId测试为2
  //     filePath: that.data.imageList[0],
  //     name: 'files',
  //     header: { TOKEN: app.globalData.token},
  //     formData: {},
  ...
  kindToggle1: function (e) {
    var showService = this.data.showServices;
    if (showService == true) {
  ...
  testPic: function () {
    ...
    console.log(this.data.imageList[0])
    wx.uploadFile({
      url: 'https://www.quannengshifu.com/api/file/ulpic2/' + 169 + '/0',
      filePath: that.data.imageList[0],
      name: 'file',
      header: { TOKEN: app.globalData.token },
      formData: {},
      success: function (res) {
        ...
        //do something
        wx.uploadFile({
          url: 'https://www.quannengshifu.com/api/file/ulpic2/' + 169 + '/1',
          filePath: that.data.imageList[1],
          name: 'file',
          header: { TOKEN: app.globalData.token },
          formData: {},
          success: function (res) {
            ...
            //do something
            wx.uploadFile({
              url: 'https://www.quannengshifu.com/api/file/ulpic2/' + 169 + '/2',
              filePath: that.data.imageList[2],
              name: 'file',
              header: { TOKEN: app.globalData.token },
              formData: {},
